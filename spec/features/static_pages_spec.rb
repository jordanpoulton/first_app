...
describe "StaticPages" do
  ...
  describe "Home page" do 
    ...
    it "should have the h1 'Jordan's Rails App'" do #Just for the user to be able to read it easy. Does nothing
      visit '/' #Uses capybara function 'visit' to simulate visiting the /home URI in a browser
    ...
    it "should have the title Jordan's Rails App" do
      visit '/'
      page.should have_selector('title', :text => "Jordan's Rails App")#Uses the 'have_selector tag'
    end
  end  
  ...
  describe "Contact" do 
    ...
    it "should have the title Contact" do
      visit '/contact'
      page.should have_selector('title', :text => "Jordan's Rails App | Contact")
    end
  end    
end
